...
nnoremap <silent> <Plug>MarkSet               :<C-u>call mark#MarkCurrentWord(v:count + 1)<cr>
vnoremap <silent> <Plug>MarkSet               :<C-u>call mark#DoMark(v:count + 1, mark#GetVisualSelectionAsLiteralPattern())<CR>
vnoremap <silent> <Plug>MarkIWhiteSet         :<C-u>if !mark#DoMark(v:count + 1, mark#GetVisualSelectionAsLiteralWhitespaceIndifferentPattern())[0]<Bar>execute "normal! \<lt>C-\>\<lt>C-n>\<lt>Esc>"<Bar>endif<CR>
nnoremap <silent> <Plug>MarkRegex             :<C-u>if !mark#MarkRegex(v:count + 1, '')<Bar>execute "normal! \<lt>C-\>\<lt>C-n>\<lt>Esc>"<Bar>if ! empty(v:errmsg)<Bar>echoerr v:errmsg<Bar>endif<Bar>endif<CR>
vnoremap <silent> <Plug>MarkRegex             :<C-u>if !mark#MarkRegex(v:count + 1, mark#GetVisualSelectionAsRegexp())<Bar>execute "normal! \<lt>C-\>\<lt>C-n>\<lt>Esc>"<Bar>if ! empty(v:errmsg)<Bar>echoerr v:errmsg<Bar>endif<Bar>endif<CR>
nnoremap <silent> <Plug>MarkClear             :<C-u>call mark#DoMark(v:count + 1, '')<cr>
